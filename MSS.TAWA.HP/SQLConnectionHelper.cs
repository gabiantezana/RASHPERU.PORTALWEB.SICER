...
namespace MSS.TAWA.HP
{
    public class SQLConnectionHelper
    {
        ...
        public ADODB.Recordset DoQuery(String connectionString, String SQLquery)
        {
            try
            {
                String _connectionString = "Provider = SQLOLEDB; " + connectionString; // Data Source = LAPTOP-GAP\\SQL2012; Initial Catalog = SICER_INT_SBO;User ID = sa; Password = root";
